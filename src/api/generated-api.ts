...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  tricks = {
     ...
     * @secure
     */
    createTrick: (data: CreateTrickDto, params: RequestParams = {}) =>
     ...
     * @request GET:/tricks
     */
    getTricks: (params: RequestParams = {}) =>
  ...
  users = {
     ...
     */
    authenticate: (data: UserAuthenticationRequestDto, params: RequestParams = {}) =>
      this.request<UserAuthenticationResponseDto, any>({
        path: `/users/login`,
        method: "POST",
        body: data,
        type: ContentType.Json,
